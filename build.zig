...
pub fn build(b: *std.Build) anyerror!void {
    ...
    const ffi_h = b.addConfigHeader(.{
        ...
        .FFI_EXEC_TRAMPOLINE_TABLE = t.os.tag.isDarwin() and (t.cpu.arch.isArm() or t.cpu.arch == .aarch64),
    ...
    const fficonfig_h = b.addConfigHeader(.{
        ...
        .FFI_EXEC_TRAMPOLINE_TABLE = if (t.os.tag.isDarwin() and (t.cpu.arch.isArm() or t.cpu.arch == .aarch64)) true else null,
        ...
        .STDC_HEADERS = true,
        .SYMBOL_UNDERSCORE = if (t.os.tag.isDarwin() or (t.os.tag == .windows and t.cpu.arch == .x86)) true else null,
        .USING_PURIFY = null,
        .VERSION = version,
