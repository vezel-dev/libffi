...
pub fn build(b: *std.Build) anyerror!void {
    ...
    const ffi_h = b.addConfigHeader(.{
        ...
        .FFI_EXEC_TRAMPOLINE_TABLE = t.os.tag.isDarwin() and t.cpu.arch == .aarch64,
    ...
    const fficonfig_h = b.addConfigHeader(.{
        ...
        .FFI_EXEC_TRAMPOLINE_TABLE = if (t.os.tag.isDarwin() and t.cpu.arch == .aarch64) true else null,
